...
public class Client{
  ...
  ImageIcon icon;
  JLabel countpkt2= new JLabel("Statistics2");
  ...
  public Client() {
    ...
    mainPanel.add(statPanel2);
    
    iconLabel.setBounds(0,0,380,280);
    buttonPanel.setBounds(0,280,380,50);
    statPanel.setBounds(20,370,380,20);
    statPanel2.setBounds(20,390,380,20); 
    f.getContentPane().add(mainPanel, BorderLayout.CENTER);
    f.setSize(new Dimension(450,370));
    f.setVisible(true);
  ...
  class timerListener implements ActionListener {
	...
	countpkt2.setText(" Transmission rate: "+(sizem/tc)+" KB/s - Burst rate: "+(rtp_packet.getpayload_length()/(-dt))+ "KB/s");
	...
	System.out.println("Recieved RTP packet with SeqNum # "+rtp_packet.getsequencenumber()+" TimeStamp "+rtp_packet.gettimestamp()+" ms, of type "+rtp_packet.getpayloadtype());
